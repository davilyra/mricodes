function [res,FLAG,RELRES,ITER,RESVEC,LSVEC] = cgNUSPIRiT3d(kData, x0, NUFFTOP, GOP, nIter, lambda)
...
[res,FLAG,RELRES,ITER,RESVEC,LSVEC] = lsqr(@(x,tflag)afun(x,NUFFTOP,GOP,dataSize, imSize,lambda,tflag), b, [], nIter);
