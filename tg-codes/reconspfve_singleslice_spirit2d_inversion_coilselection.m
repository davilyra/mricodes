...
%==========================================================================
        ...
        for p = 1:nphases
            ...
            xyvt(:,:,:,p) = combine4channels(xyvc(:,:,:,1),xyvc(:,:,:,2),0,0); % combines the data from the first two coils
            % xyvt(:,:,:,p) = combine4channels(0,xyvc(:,:,:,2),xyvc(:,:,:,3),0); % combines the data from the second and the third coils
        end
...
%==========================================================================
        ...
        save(sprintf('slice_%d_spirit_coils_12_%d.mat',slice,accel), 'xyvt', 'xy', 'maxveloc', 'optr');
        disp('Done!')
        cd ..
        cd ..
