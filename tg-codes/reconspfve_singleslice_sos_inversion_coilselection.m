...
%==========================================================================
        ...
        cd datapaper\sosnufft_coil_selection
        save(sprintf('slice_%d_sosnufft_coils_12_%d.mat',slice,undersamplingfactor), 'xyvt','xy','maxveloc', 'optr');
%         save(sprintf('slice_%d_sosnufft_coils_23_%d.mat',slice,undersamplingfactor), 'xyvt','xy','maxveloc', 'optr');
        disp('Done!')
        cd ..
        cd ..
